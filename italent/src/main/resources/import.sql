...
insert into category (last_update, last_updated_by, status, description) values('2016-01-01', 'Team1', 'A', 'Information Technology');
...
insert into project_category(project_id, category_id) values (2,6);
