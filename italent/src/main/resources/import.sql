...
insert into likes(last_update, last_updated_by, status, user_id, project_id) values('2016-01-01', 'Team1', 'A', 4, 2);
insert into likes(last_update, last_updated_by, status, user_id, project_id) values('2016-01-01', 'Team1', 'A', 5, 2);
insert into likes(last_update, last_updated_by, status, user_id, project_id) values('2016-01-01', 'Team1', 'A', 5, 1);

-- Pictures
--insert into picture(last_update, last_updated_by, status, project_id, description) values('2016-01-01', 'Team1', 'A', 1, 'Toppertje');

-- Movies
insert into movie(last_update, last_updated_by, status, project_id, description, youtube_id) values('2016-01-01', 'Team1', 'A', 1, 'Mike Posner - I Took A Pill In Ibiza (SeeB Remix)', 'u3VFzuUiTGw');
