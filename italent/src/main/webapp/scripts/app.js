 ...
 */
(function () {
    angular.module('iTalentApp', ['ngRoute', 'ngResource', 'pascalprecht.translate', 'tmh.dynamicLocale', 'ngCookies', 'ngAnimate', 'ui.bootstrap', 'ngTagsInput', '720kb.socialshare', 'toastr'])
