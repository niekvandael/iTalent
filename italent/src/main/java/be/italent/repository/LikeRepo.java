...
public interface LikeRepo extends JpaRepository<Like, Integer> {
    @Query("select l from Like l where l.user = :user and l.project = :project")
    Like getLikeByProject(@Param("project") final Project project, @Param("user") final User user);
}
